...
ハイパーリンクの設定は、設定漏れのものや誤った設定のものもありますので、ご容赦ください。例えば、所得税法第１２４条第１項の「政令で定めるところのより」の政令は、所得税法施行令第２１７条第１項第４号に誤って設定されています。
...
表の表示を修正（措法第３７条第１項、措令第２５条の８第１６項など）

### version0.9.5

号の文に、ルビがある場合の変換ミスを修正

## 防衛特別法人税

防衛特別法人税に関する法律などの名称は、下記です。
