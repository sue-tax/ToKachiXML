...
#    逆に、多くなりすぎる弊害あり
#     matchTaJouKouNoKiteiniyori = re.compile(
#             r'(?<!\[)([法令])' \
#             '(第([一二三四五六七八九十百千]+)条' \
#             '(の([一二三四五六七八九十百千]+)' \
#             '(の([一二三四五六七八九十百千]+))?)?)' \
...
#             m_niKiteiniyoru = \
#                     Bun.matchTaJouKouNoKiteiniyori. \
#                     search(self.kakou_bun, m.start())
#             if m_niKiteiniyoru != None:
#                 ref_pair_tuple = (self.zeihou_mei,
#                         ref_kubun,
#                         '＿',
#                         ref_tuple)
...
（１）　古物営業法（昭和二十四年法律第百八号）第二条第二項（定義）に規定する古物営業を営む同条第三項に規定する古物商である事業者が、他の者（適格請求書発行事業者を除く。ハにおいて同じ。）から買い受けた同条第一項に規定する古物（これに準ずるものとして財務省令で定めるものを含む。）

（２）　質屋営業法（昭和二十五年法律第百五十八号）第一条第一項（定義）に規定する質屋営業を営む同条第二項に規定する質屋である事業者が、同法第十八条第一項（流質物の取得及び処分）の規定により他の者から所有権を取得した質物

（３）　宅地建物取引業法（昭和二十七年法律第百七十六号）第二条第二号（用語の定義）に規定する宅地建物取引業を営む同条第三号に規定する宅地建物取引業者である事業者が、他の者から買い受けた同条第二号に規定する建物

（４）　再生資源卸売業その他不特定かつ多数の者から再生資源等（資源の有効な利用の促進に関する法律（平成三年法律第四十八号）第二条第四項（定義）に規定する再生資源及び同条第五項に規定する再生部品をいう。）に係る課税仕入れを行う事業を営む事業者が、他の者から買い受けた当該再生資源等

ニ　イからハまでに掲げるもののほか、請求書等（法第三十条第七項に規定する請求書等をいう。）の交付又は提供を受けることが困難な課税仕入れとして財務省令で定めるもの
'''
    testmatchTaJouKouNiKiteisuru = re.compile(
        r'(?<!\[)([法令])' \
        '(第([一二三四五六七八九十百千]+)条' \
        '(の([一二三四五六七八九十百千]+)' \
        '(の([一二三四五六七八九十百千]+))?)?)' \
    ...
    m = testmatchTaJouKouNiKiteisuru.search(text_)
    print(m)
    if (m != None):
        print(m.groups())
